function Get-HVToolsConfig {
    <#
    .SYNOPSIS
        Gets the HVTools configuration with improved formatting
    
    .DESCRIPTION
        Retrieves and displays the HVTools configuration in an organized, readable format
    ...
    try {
        if ($script:hvConfig) {
            ...
            Write-Host "`n==== HVTools Configuration ====" -ForegroundColor Cyan
